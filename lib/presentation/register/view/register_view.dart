                      ...
                      builder: (context, snapshot) {
                        return TextFormField(
                          ...
                          decoration: InputDecoration(
                              hintText: AppStrings.username, labelText: AppStrings.username, errorText: snapshot.data),
                        );
                      }),
                ),
                const SizedBox(
                  ...
                  child: StreamBuilder<String?>(
                      ...
                      builder: (context, snapshot) {
                        return TextFormField(
                          ...
                          decoration: InputDecoration(
                              hintText: AppStrings.password, labelText: AppStrings.password, errorText: snapshot.data),
                        );
                      }),
                ),
                const SizedBox(
